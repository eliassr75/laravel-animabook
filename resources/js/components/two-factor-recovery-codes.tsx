    ...
    return (
        <Card>
            <CardHeader>
                ...
                <CardDescription>
                    Esses códigos permitem recuperar o acesso se você perder o
                    dispositivo de autenticação. Guarde-os em local seguro.
                </CardDescription>
            </CardHeader>
            <CardContent>
                            ...
                            <>
                                ...
                                <div className="text-xs text-muted-foreground select-none">
                                    <p id="regenerate-warning">
                                        ...
                                        usado uma única vez e será removido
                                        após o uso. Se precisar de novos, clique
                                        em{' '}
