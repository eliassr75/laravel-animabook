...
export default function PeopleDetail({ entity, related = [], relatedAnime = [], relatedManga = [] }: PeopleDetailProps) {
    ...
    <AppShell>
      <div className="container mx-auto px-4 py-8">
        ...
        {(animeItems.length > 0 || mangaItems.length > 0) && (
          <div className="mt-10">
            <h2 className="font-heading text-xl font-bold mb-4">Créditos</h2>
            {animeItems.length > 0 && (
